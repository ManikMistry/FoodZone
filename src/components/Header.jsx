...
const Header = () => {
  ...
  return (
    <header className="fixed x-50 w-screen  p-3 px-4 md:p-6 md:px-6 bg-primary">
      {/* Desktop and Tablet */}
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          <img
            ...
            alt="logo"
          />
          <p className="text-headingColor text-x1 font-bold cursor-pointer">
            FoodZone
          </p>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-red-600 flex items-center justify-center">
              <p className="text-x5 text-black font-semibold">2</p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                ...
                <p className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-bas"
                onClick={logout}
                >
                  Log out <MdLogout />
                </p>
